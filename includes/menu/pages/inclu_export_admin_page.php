	...
	<script>
		...
		function parseCsv(data) {
			const COLUMNS_NAMES = {
				...
				'Nivel de inglés': 'nivel_de_ingles',
				'Candidate Email Address': 'candidate_email_address',
				'Detalle discapacidad': 'detalle_discapacidad',
				'País de nacimiento': 'pais_de_nacimiento',
				'Búsqueda laboral': 'busqueda_laboral',
				'Máximo nivel de estudios alcanzado': 'maximo_nivel_de_estudios_alcanzado',
				'Área de interés': 'area_de_interes',
				'Vivienda': 'Vivienda',
				'Empleo': 'Empleo',
				'Birthdate': 'Birthdate',
				'Gender': 'Gender',
